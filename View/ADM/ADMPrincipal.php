...
<body class="w3-light-grey">]
    ...
    <form action="<?= __ROOT__.'/Controller/Navegacao.php'?>" method="post" class="w3-container w3-light-grey w3-text-blue w3-margin w3-center" style="">
        ...
        <button name="btnListarAdministradores" class="w3-button w3-margin w3-blue w3-cell w3-round-large" style="">
            <br>
            <i class="fa fa-address-book-o w3-xxlarge"></i><br>
